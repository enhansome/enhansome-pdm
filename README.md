...
* [pdm-bump](https://github.com/carstencodes/pdm-bump) ⭐ 44 | 🐛 1 | 🌐 Python | 📅 2026-08-19 - A PDM plugin that behaves like [bump2version](https://github.com/c4urself/bump2version) ⭐ 1,115 | 🐛 115 | 🌐 Python | 📅 2025-02-20 relying on PEP440 compliant versions
...
* [pdm-readiness](https://github.com/andriykohut/pdm-readiness) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-08-21 - A PDM plugin to check if your project dependencies support specified Python version
...
* [pdm-audit](https://github.com/carstencodes/pdm-audit) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-08-19 - A PDM plugin that hooks into the installation end executes [pip-audit](https://github.com/pypa/pip-audit) ⭐ 1,351 | 🐛 69 | 🌐 Python | 📅 2026-08-20 right after installation or manually
