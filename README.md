...
* [pdm-bump](https://github.com/carstencodes/pdm-bump) ⭐ 45 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - A PDM plugin that behaves like [bump2version](https://github.com/c4urself/bump2version) ⭐ 1,117 | 🐛 115 | 🌐 Python | 📅 2025-02-20 relying on PEP440 compliant versions
...
* [pdm-readiness](https://github.com/andriykohut/pdm-readiness) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-09-17 - A PDM plugin to check if your project dependencies support specified Python version
...
* [pdm-audit](https://github.com/carstencodes/pdm-audit) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - A PDM plugin that hooks into the installation end executes [pip-audit](https://github.com/pypa/pip-audit) ⭐ 1,363 | 🐛 64 | 🌐 Python | 📅 2026-09-16 right after installation or manually
...
* [pdm-ci](https://github.com/Seven45/pdm-ci) ⭐ 10 | 🐛 1 | 🌐 Dockerfile | 📅 2026-09-16 - A docker image for usage in multistage builds or gitlab-ci
