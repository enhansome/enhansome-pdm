...
* [pdm-bump](https://github.com/carstencodes/pdm-bump) ⭐ 45 | 🐛 2 | 🌐 Python | 📅 2026-09-14 - A PDM plugin that behaves like [bump2version](https://github.com/c4urself/bump2version) ⭐ 1,116 | 🐛 115 | 🌐 Python | 📅 2025-02-20 relying on PEP440 compliant versions
...
* [pdm-build-locked](https://github.com/sigma67/pdm-build-locked) ⭐ 9 | 🐛 3 | 🌐 Python | 📅 2026-09-14 - A PDM plugin to add locked packages as additional optional dependency groups to the distribution metadata on build
* [pdm-wheel](https://github.com/GabDug/pdm-wheel) ⭐ 9 | 🐛 5 | 🌐 Python | 📅 2026-09-14 - A PDM plugin to export your dependencies wheels, mainly for CI and deployments
...
* [pdm-audit](https://github.com/carstencodes/pdm-audit) ⭐ 4 | 🐛 2 | 🌐 Python | 📅 2026-09-14 - A PDM plugin that hooks into the installation end executes [pip-audit](https://github.com/pypa/pip-audit) ⭐ 1,363 | 🐛 62 | 🌐 Python | 📅 2026-09-09 right after installation or manually
...
* [pdm-ci](https://github.com/Seven45/pdm-ci) ⭐ 10 | 🐛 1 | 🌐 Dockerfile | 📅 2026-09-14 - A docker image for usage in multistage builds or gitlab-ci
