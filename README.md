...
* [pdm-packer](https://github.com/frostming/pdm-packer) ⭐ 51 | 🐛 3 | 🌐 Python | 📅 2026-08-10 - A PDM plugin that packs your packages into a zipapp
* [pdm-bump](https://github.com/carstencodes/pdm-bump) ⭐ 44 | 🐛 1 | 🌐 Python | 📅 2026-08-12 - A PDM plugin that behaves like [bump2version](https://github.com/c4urself/bump2version) ⭐ 1,115 | 🐛 115 | 🌐 Python | 📅 2025-02-20 relying on PEP440 compliant versions
...
* [sync-pre-commit-lock](https://github.com/GabDug/sync-pre-commit-lock) ⭐ 29 | 🐛 5 | 🌐 Python | 📅 2026-08-09 - A PDM plugin to ease your life with `pre-commit` (automatic install, sync)
...
* [pdm-shear](https://github.com/pdm-project/pdm-shear) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2025-04-05 - Detect and remove unused dependencies for Python projects
* [pdm-download](https://github.com/pdm-project/pdm-download) ⭐ 17 | 🐛 4 | 🌐 Python | 📅 2024-07-18 - A PDM plugin to download all packages in a lockfile for offline use
...
* [pdm-build-locked](https://github.com/sigma67/pdm-build-locked) ⭐ 9 | 🐛 2 | 🌐 Python | 📅 2025-11-30 - A PDM plugin to add locked packages as additional optional dependency groups to the distribution metadata on build
* [pdm-wheel](https://github.com/GabDug/pdm-wheel) ⭐ 9 | 🐛 5 | 🌐 Python | 📅 2026-08-10 - A PDM plugin to export your dependencies wheels, mainly for CI and deployments
...
* [pdm-audit](https://github.com/carstencodes/pdm-audit) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-08-14 - A PDM plugin that hooks into the installation end executes [pip-audit](https://github.com/pypa/pip-audit) ⭐ 1,344 | 🐛 69 | 🌐 Python | 📅 2026-08-12 right after installation or manually
...
* [tox-pdm](https://github.com/pdm-project/tox-pdm) ⭐ 26 | 🐛 7 | 🌐 Python | 📅 2026-08-10 - A plugin for tox that utilizes PDM as the package manager and installer
...
* [pdm-ci](https://github.com/Seven45/pdm-ci) ⭐ 10 | 🐛 1 | 🌐 Dockerfile | 📅 2026-08-13 - A docker image for usage in multistage builds or gitlab-ci
* [sync\_with\_pdm](https://github.com/floatingpurr/sync_with_pdm) ⭐ 10 | 🐛 1 | 🌐 Python | 📅 2026-08-10 - a `pre-commit` hook to keep PDM-managed packages and pre-commit hooks in sync
