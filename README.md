...
* [pdm-bump](https://github.com/carstencodes/pdm-bump) ⭐ 45 | 🐛 2 | 🌐 Python | 📅 2026-09-25 - A PDM plugin that behaves like [bump2version](https://github.com/c4urself/bump2version) ⭐ 1,118 | 🐛 115 | 🌐 Python | 📅 2025-02-20 relying on PEP440 compliant versions
...
* [sync-pre-commit-lock](https://github.com/GabDug/sync-pre-commit-lock) ⭐ 29 | 🐛 6 | 🌐 Python | 📅 2026-09-19 - A PDM plugin to ease your life with `pre-commit` (automatic install, sync)
...
* [pdm-multirun](https://github.com/pawamoy/pdm-multirun) ⚠️ Archived - A PDM plugin to run a command on multiple Python versions
* [pdm-readiness](https://github.com/andriykohut/pdm-readiness) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-09-25 - A PDM plugin to check if your project dependencies support specified Python version
...
* [pdm-audit](https://github.com/carstencodes/pdm-audit) ⭐ 4 | 🐛 3 | 🌐 Python | 📅 2026-09-26 - A PDM plugin that hooks into the installation end executes [pip-audit](https://github.com/pypa/pip-audit) ⭐ 1,370 | 🐛 61 | 🌐 Python | 📅 2026-09-26 right after installation or manually
...
* [setup-pdm](https://github.com/pdm-project/setup-pdm) ⭐ 97 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-13 - A GitHub Action that installs pdm properly for all Python versions
...
* [pdm-ci](https://github.com/Seven45/pdm-ci) ⭐ 10 | 🐛 1 | 🌐 Dockerfile | 📅 2026-09-25 - A docker image for usage in multistage builds or gitlab-ci
