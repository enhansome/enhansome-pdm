...
* [pdm-audit](https://github.com/carstencodes/pdm-audit) ⭐ 4 | 🐛 2 | 🌐 Python | 📅 2026-08-25 - A PDM plugin that hooks into the installation end executes [pip-audit](https://github.com/pypa/pip-audit) ⭐ 1,358 | 🐛 69 | 🌐 Python | 📅 2026-08-20 right after installation or manually
...
* [pdm-ci](https://github.com/Seven45/pdm-ci) ⭐ 10 | 🐛 1 | 🌐 Dockerfile | 📅 2026-08-27 - A docker image for usage in multistage builds or gitlab-ci
