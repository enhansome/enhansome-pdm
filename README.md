...
* [pdm-audit](https://github.com/carstencodes/pdm-audit) ⭐ 4 | 🐛 3 | 🌐 Python | 📅 2026-08-31 - A PDM plugin that hooks into the installation end executes [pip-audit](https://github.com/pypa/pip-audit) ⭐ 1,360 | 🐛 64 | 🌐 Python | 📅 2026-09-03 right after installation or manually
...
* [pdm-ci](https://github.com/Seven45/pdm-ci) ⭐ 10 | 🐛 1 | 🌐 Dockerfile | 📅 2026-09-03 - A docker image for usage in multistage builds or gitlab-ci
